...
<body>
	...
	<!-- Search Appointment -->
		<div class="card">
			...
			<form action="appointment" method="get">
				...
				<div class="form-group">
					<label>Appointment Number</label> <input type="number"
						name="appointmentNo" min="1" required
		...
		<!-- Search Result -->
		<%
		com.sunrise.dental.model.Appointment appointment = (com.sunrise.dental.model.Appointment) request
		...
		<div class="card">
			...
			<div class="appointment-details">
				...
				<p>
					<strong>Treatment Fee:</strong> Rs.
